...
class UpdateMaintenanceTimingsHandlerTest {
    ...
    @Test
    void givenValidTimings_whenHandle_thenSavesMaintenanceTimings() {
        UpdateMaintenanceTimingsCommand command = new UpdateMaintenanceTimingsCommand(1L,"08:00", "10:00");
        MaintenanceTimings maintenanceTimings = new MaintenanceTimings(LocalTime.parse("08:00"), LocalTime.parse("10" +
                ":00"));
        ...
        Long id = updateMaintenanceTimingsHandler.handle(command);
